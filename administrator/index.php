...
<div class="row">
      ...
      <div class="col">
        <div class="card" style="width: 10rem;">
          <img src="../img/pembeli.png" class="card-img-top" alt="..." height="150px">
          <div class="card-body">
            <p class="card-text">
              <button type="button" class="btn btn-primary">
      ...
      <div class="col">
        <div class="card" style="width: 10rem;">
        <img src="../img/pelanggan.jpg" class="card-img-top" alt="..." height="150px">
          <div class="card-body">
            <p class="card-text">
              <button type="button" class="btn btn-primary">
                Pelangan <span class="badge text-bg-secondary"> <?= $jumlahPenjualan['Jumlah']; ?></span>
              </button>
            </p>
          </div>
        </div>
