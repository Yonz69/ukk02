...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 06, 2024 at 04:59 AM
...
(1, 'tisu megic', 550, 15.00),
(3, 'bomm', 890, 4500.00),
(4, 'LL', 780, 25000.00),
(5, 'sabun colek', 310, 25000.00);
...
(1, 'dion', 'dion', '1234', 'petugas'),
(5, 'Ach ujiono', 'dionn', '1234', 'administrator'),
(6, 'ach ujiono', 'ujian', '1234', 'administrator'),
(7, 'matos', 'matoss', '1234', 'petugas');
...
CREATE TABLE `tb_pelanggan` (
  ...
  `telepon_pelanggan` varchar(20) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(22206, 'yonz', 'junok', '0876434567'),
(32555, 'dayat', 'blga', '4567097654678'),
(34335, 'potato', 'bngkln', '0876434567'),
(34354, 'fumm', 'sampang', '987re24567876');
...
(15, '2024-02-20', 0.00, 22206, 1),
(21, '2024-03-06', 0.00, 32555, 1),
(22, '2024-03-06', 0.00, 34335, 1),
(23, '2024-03-06', 0.00, 34354, 1);
...
--
ALTER TABLE `tb_detail_penjualan`
  MODIFY `id_detail_penjualan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=64;
